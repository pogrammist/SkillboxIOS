...
@IBDesignable class ThreeSegmentedControl: UISegmentedControl, CustomSegmentControlDelegate {
    ...
    @objc private func changeSelectedItem(sender: UISegmentedControl)
    {
        if #available(iOS 13.0, *) {
            ...
            let subViewOfSegment: UIView = getSelectedItem()
